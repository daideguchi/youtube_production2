...
Usage:
  python3 audio_tts_v2/scripts/sync_voicevox_user_dict.py --channel CH05
  python3 audio_tts_v2/scripts/sync_voicevox_user_dict.py --all
...
def _channel_speaker_id(channel: str) -> int | None:
    cfg_path = Path("script_pipeline/audio/channels") / channel / "voice_config.json"
