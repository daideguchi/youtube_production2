...
def main():
    ...
    if args.intent == "new":
        ...
        logger.info("🔧 FIX Mode: Forcing regeneration of images...")
        base_cmd.append("--force")

    elif args.intent == "check":
        logger.info("🔍 CHECK Mode: Dry-run...")
