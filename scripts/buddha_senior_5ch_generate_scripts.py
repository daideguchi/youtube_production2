#!/usr/bin/env python3
"""
Offline script mass-production for the Buddha senior 5ch set (CH12–CH16).

Goals:
- No external LLM calls (SCRIPT_PIPELINE_DRY=1)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate CH12–CH16 scripts offline (no LLM API).")
    ...
    # Enforce offline mode for all script stages.
