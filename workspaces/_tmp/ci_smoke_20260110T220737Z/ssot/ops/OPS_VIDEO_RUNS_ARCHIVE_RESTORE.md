...
関連:
- 確定フロー: `ssot/ops/OPS_CONFIRMED_PIPELINE_FLOW.md`（Phase D: Video）
- 生成物ライフサイクル: `ssot/plans/PLAN_OPS_ARTIFACT_LIFECYCLE.md`
- cleanup 実行ログ: `ssot/ops/OPS_CLEANUP_EXECUTION_LOG.md`
...
- 退避の実行記録（なぜ/どう実行したか）: `ssot/ops/OPS_CLEANUP_EXECUTION_LOG.md`
- 差分確認: `git diff ssot/ops/OPS_CLEANUP_EXECUTION_LOG.md`
