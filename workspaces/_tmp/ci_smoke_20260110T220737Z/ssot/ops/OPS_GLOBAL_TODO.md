...
関連:
- 協調運用: `ssot/ops/OPS_AGENT_PLAYBOOK.md`, `ssot/plans/PLAN_AGENT_ORG_COORDINATION.md`
- リポジトリ再編: `ssot/plans/PLAN_REPO_DIRECTORY_REFACTOR.md`, `ssot/ops/OPS_REPO_DIRECTORY_SSOT.md`
- 入口: `ssot/ops/OPS_ENTRYPOINTS_INDEX.md`
...
- [ ] `TODO-LOG-001` ログ爆増ポイントの“入口”を特定してSSOTに固定（P0, todo）
  - scope: `ssot/ops/OPS_LOGGING_MAP.md`, `workspaces/logs/**`, `scripts/**`
...
- [ ] `TODO-SCRIPT-002` 2〜3時間級（Marathon）の作業分割・収束条件を明文化（P1, todo）
  - scope: `scripts/ops/a_text_marathon_compose.py`, `ssot/ops/OPS_LONGFORM_SCRIPT_SCALING.md`
  - thread: `note__20251222T145515Z__663aa912`
...
- [ ] `TODO-SSOT-001` SSOT索引を常に最新化（P2, todo）
  - scope: `ssot/DOCS_INDEX.md`, `ssot/plans/PLAN_STATUS.md`
...
- [ ] `TODO-REPO-001` Stage6（互換symlink縮退 + cleanup自動化 + pyproject整備）を完了（P2, todo）
  - scope: `ssot/plans/PLAN_REPO_DIRECTORY_REFACTOR.md`, `pyproject.toml`, `scripts/ops/**`
...
- [ ] `TODO-UI-002` Episode Studio（統合導線）へ段階統合（P2, todo）
  - scope: `ssot/plans/PLAN_UI_EPISODE_STUDIO.md`, `apps/ui-*`
  - thread: `note__20251222T145553Z__1a607eb2`
