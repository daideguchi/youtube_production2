...
## 0. テンプレ SoT
- SoT: `workspaces/planning/templates/CH01_planning_template.csv`
...
> `workspaces/planning/channels/CHxx.csv`（および `workspaces/planning/channels/CH01.csv`）の末尾にこれら8列を追加済み。既存行は空欄のままで構わないが、No.191以降は必ず埋める。
...
## 4. コピペ用テンプレ
- ファイル: `workspaces/planning/templates/CH01_planning_template.csv`
