...
- Active/Draft/Paused の計画書は `ssot/plans/` に置く
...
- `plans/PLAN_CAPCUT_HOT_VAULT_ROLLOUT.md`（最終更新 2026-01-26）: CapCut運用（Hot=Mac / Vault=Lenovo外付け / UI=Acer常駐）移行手順。
...
## Template
- `plans/PLAN_TEMPLATE.md`: 新規計画書のテンプレ。
