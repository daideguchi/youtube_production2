...
- 台本アーキテクチャ: `ssot/OPS_SCRIPT_GENERATION_ARCHITECTURE.md`
- Aテキスト品質ゲート: `ssot/OPS_A_TEXT_LLM_QUALITY_GATE.md`
...
- SSOTパターン（骨格・字数配分）: `ssot/OPS_SCRIPT_PATTERNS.yaml`
- 全チャンネル共通ルール: `ssot/OPS_A_TEXT_GLOBAL_RULES.md`
