...
- Aテキスト（SoT）が存在することを確認:
  - 優先: `workspaces/scripts/{チャンネル}/{動画番号}/content/assembled_human.md`
  - 代替: `workspaces/scripts/{チャンネル}/{動画番号}/content/assembled.md`
- `assembled_human.md` がある場合はそれが正本、`assembled.md` は互換用 mirror（split-brain は **STOP** して明示解決）。
