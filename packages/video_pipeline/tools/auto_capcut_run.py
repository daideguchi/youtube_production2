...
def make_llm_belt_from_cues(run_dir: Path, opening_offset: float = 0.0, sections: int = 4, channel_id: str | None = None):
    ...
    from video_pipeline.src.srt2images.belt_generator import generate_belt_from_script
...
def _load_planning_row(episode: EpisodeId) -> dict[str, str] | None:
    """
    Load the planning CSV row for an episode.
...
def main():
    ...
    # Resolve SoT SRT/WAV from audio_tts final when possible.
