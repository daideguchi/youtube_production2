...
export const AudioTtsPage: React.FC = () => {
    ...
    <div style={{ padding: 24, maxWidth: 1200, margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 12 }}>
          ...
          <Link className="action-chip" to={selectedChannel ? `/planning?channel=${encodeURIComponent(selectedChannel)}` : "/planning"}>
            企画CSV
          </Link>
